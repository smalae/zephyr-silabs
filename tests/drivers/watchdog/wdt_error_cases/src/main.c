...
#elif DT_HAS_COMPAT_STATUS_OKAY(silabs_siwx917_watchdog)
#define WDT_NODE DT_INST(0, silabs_siwx917_watchdog)
#endif
...
#define WDT_TEST_FLAGS                                                                             \
	(WDT_DISABLE_SUPPORTED | WDT_FLAG_RESET_SOC_SUPPORTED |                                    \
	 WDT_FLAG_RESET_NONE_SUPPORTED | WDT_FLAG_RESET_CPU_CORE_SUPPORTED | WDT_OPT_PAUSE_HALTED_BY_DBG_SUPPORTED)
#define DEFAULT_FLAGS            (WDT_FLAG_RESET_SOC)
#define MAX_INSTALLABLE_TIMEOUTS (1)
#define WDT_WINDOW_MAX_ALLOWED   (0x03E80000U)
